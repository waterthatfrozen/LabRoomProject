...
<tr>
	<td colspan="8" align="center">รายการวัสดุ-อุปกรณ์เคมี</td>
    <td colspan="3" align="center"><a href="add_equipment.php">เพิ่มอุปกรณ์เคมี</a></td>
    </tr>
<tr align="center">
	<th width="5%">ที่</th>
...
<? include "../conn_db.php";
$sql="SELECT * FROM equipment WHERE eq_type = 'chm'";
...
<tr align="center">
	...
	<td><a href="detail_equip.php?id=<?=$data[eq_id]?>&to=equip_chm.php" title="ดูข้อมูลอย่างละเอียด"><img src="../img/16.png" width="20" height="20"/></a></td>
	<td><a href="add_equipment.php?act=edit&id=<?=$data[eq_id]?>&to=equip_chm.php" title="แก้ไขข้อมูล"><img src="../img/edit.png" width="20" height="20"/></a></td>
